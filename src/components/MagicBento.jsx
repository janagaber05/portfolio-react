import { useCallback, useEffect, useMemo, useRef, useState, isValidElement } from 'react';
...
const FALLBACK_CARDS = [
  {
    color: '#060010',
    title: 'Analytics',
    description: 'Track user behaviour',
    label: 'Insights',
  },
  {
    color: '#060010',
    title: 'Dashboard',
    description: 'Centralised data view',
    label: 'Overview',
  },
  {
    color: '#060010',
  ...
  },
  {
    color: '#060010',
    title: 'Integration',
    description: 'Connect favourite tools',
    label: 'Connectivity',
  },
  {
    color: '#060010',
  ...
  const preparedCards = useMemo(() => {
    if (Array.isArray(cards) && cards.length) {
      return cards.map(card => ({
        color: card.color || '#060010',
        title: card.title || '',
        description:
          typeof card.description === 'string' || isValidElement(card.description)
            ? card.description
            : '',
        label: card.label || '',
